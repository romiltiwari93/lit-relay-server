...
(0, node_fetch_1.default)("https://mds3.certinfra.fidoalliance.org/getEndpoints", {
    method: "POST",
    body: JSON.stringify({
        endpoint: `${config_1.default.expectedOrigins[0]}${exports.fidoRouteSuffix}`, // TODO: this is a hack using the first in the array.
    }),
...
exports.fidoConformanceRouter.post("/attestation/result", async (req, res) => {
    ...
    try {
        verification = await (0, server_1.verifyRegistrationResponse)({
            ...
            expectedOrigin: config_1.default.expectedOrigins,
            supportedAlgorithmIDs,
        });
    }
    catch (error) {
